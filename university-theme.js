...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      /* ---- 主题变量消费（仅在选择大学后生效） ---- */
      html[data-ut] body{background:radial-gradient(circle at 8% 0%,var(--ut-tint) 0,transparent 30%),radial-gradient(circle at 92% 8%,var(--ut-soft) 0,transparent 26%),var(--bg)}
